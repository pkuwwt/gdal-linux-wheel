...
# Modified by Kerim Khemraev kerimhemraev@gmail.com
...
def copy_content(srcdir, destdir):
...
maintainer_email = "kerimhemraev@gmail.com"
...
# Copy gdal/proj data.
copy_content('/usr/local/share/proj', 'osgeo/data/proj')
copy_content('/install/gdal/share/gdal', 'osgeo/data/gdal')
copy_content('/install/gdal/bin', 'osgeo')
copy_content('/install/gdal/lib', 'osgeo/lib')
copy_content('/install/gdal/include', 'osgeo/include/gdal')

exclude_package_data = {'':['GNUmakefile']}

# import time

# print("WORKING_DIR: " + os.path.abspath(os.getcwd()))
...
setup( name = name,
        ...
        package_data={
            'osgeo': ['*', 'data/gdal/*', 'data/proj/*', 'lib/*', 'include/gdal/*']},
        **extra )